...
# split_master.py
# 2023/07/22
# 2025/07/03 Modified to generate the dataset from PNG files.
...
to test, train and valid subsets.

./Kits19-Kidney-Tumor-ImageMask-Dataset
├─test
│  ├─images
│  └─masks
├─train
...
if __name__ == "__main__":
  try:
    images_dir = "./Kits19-PNG-master/images/"
    masks_dir  = "./Kits19-PNG-master/masks/"
    output_dir = "./Kits19-Kidney-Tumor-ImageMask-Dataset/"
